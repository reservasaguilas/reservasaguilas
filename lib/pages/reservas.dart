...
import 'package:reservasaguilas/pages/pdfReserva.dart';
                ...
                child: SizedBox(
                  ...
                  child: RaisedButton(
                      ...
                      onPressed: (){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => VerPdfReserva(dni: dni, observacion: observacion, pax: pax, fechaIngreso: fechaIngreso, fechaSalida: fechaSalida, firma: valueChoise, horaEgreso: horaEgreso, horaIngreso: horaIngreso, valorNoche: valorNoche, titular: titular, total: total, adelanto: adelanto,)));
                      }, 
                      color: Color.fromRGBO(72, 202, 228, 1),
                      elevation: 3,
                  ),
